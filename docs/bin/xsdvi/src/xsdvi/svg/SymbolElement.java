...
public class SymbolElement extends AbstractSymbol{	
	...
	public void draw() {
		...
		drawMouseover();
		if (namespace!=null) {
			print("<text class='element-namespace' x='5' y='13'>"+namespace+"</text>");
		}
		...
		if (name!=null) {
			print("<text class='element-name' x='5' y='27'>"+name+"</text>");
		}
		if (type!=null) {
			print("<text class='element-type' x='5' y='41'>"+type+"</text>");
		}
		if (cardinality!=null) {
