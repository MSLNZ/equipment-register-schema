...
def test_asset_number_repeated(xml, kwargs):
    xml.financial(asset_number='123', **kwargs)
...
def test_warranty_repeated(xml, kwargs):
    xml.financial(warranty_date='2030-05-19', **kwargs)
...
def test_year_purchased_repeated(xml, kwargs):
    xml.financial(year_purchased='1984', **kwargs)
