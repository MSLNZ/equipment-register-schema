...
def test_component_name_not_unique_different_measurand(xml, value):
    m1 = xml.measurand(xml.component(name=value), quantity='Humidity', calibrationInterval=5)
    m2 = xml.measurand(xml.component(name=value), quantity='Temperature', calibrationInterval=5)
